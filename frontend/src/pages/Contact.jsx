    ...
    <main style={{ paddingTop: 60, background: '#050505', color: 'white' }}>
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
            .hero-wrapper { 
                ...
                gap: 10px !important; 
                margin-bottom: 80px !important; /* Space barha di gayi hai */
            ...
            .mobile-contact-label { 
                display: block !important; /* Mobile par show hoga */
      ...
      <section className="section" style={{ paddingTop: 20 }}>
        <div className="container">
          ...
          {/* ══ HERO SECTION ══ */}
          <div className="hero-wrapper" style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 20, alignItems: 'flex-end', marginBottom: 120 }}>
            <Reveal>
              <div className="hero-text" style={{ textAlign: 'left', paddingBottom: 40 }}>
          ...
          {/* ── MOBILE ONLY LABEL ── */}
          <div className="mobile-contact-label">CONTACT US</div>

          <div className="details-form-wrapper" style={{ display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: 60, alignItems: 'start' }}>
            ...
            {/* ── RIGHT: FORM ── */}
            <Reveal delay={0.2}>
              <div className="form-container" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,100,0,0.1)', borderRadius: 16, padding: 45 }}>
