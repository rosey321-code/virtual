    ...
    <main style={{ background: '#050505', color: 'white', overflowX: 'hidden' }}>
      ...
      <section className="section" style={{ minHeight: '90vh', display: 'flex', alignItems: 'center', paddingTop: 100, position:'relative' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 40, alignItems: 'center' }}>
          ...
          >
            <img src="/brand1.jpg" style={{ width: '110%', borderRadius: '0 40px 40px 0', boxShadow: '20px 0 50px rgba(255,107,0,0.2)' }} alt="About Hero" />
          </motion.div>
      ...
      <section className="section" style={{ background: '#0a0a0a' }}>
        <div className="container">
          <div ref={ref} style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:30 }}>
            {stats.map((s, i) => (
      ...
      {/* Team Section with Fixed Image Logic */}
            ...
            {team.map((m, i) => (
              <Reveal key={m.name} delay={i * 0.1}>
                <div style={{ textAlign:'center' }}>
                  ...
                  {/* Circle with Horizontal Flip Animation */}
                  <motion.div 
                    animate={{ rotateY: 360 }}
                  ...
                  <p style={{ color:'rgba(255,255,255,0.6)', fontSize:15, lineHeight:1.7 }}>{m.bio}</p>
                </div>
              </Reveal>
            ))}
          </div>
